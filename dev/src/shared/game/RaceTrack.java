...
public class RaceTrack {
	...
	public static ImageIcon[] getCarImageArray() {
		...
		carII[0] = scaleImageIcon(new ImageIcon(
				RaceTrack.class.getResource("/shared/game/images/car1Red.png")));
		carII[1] = scaleImageIcon(new ImageIcon(
				RaceTrack.class.getResource("/shared/game/images/car2Blue.png")));
		carII[2] = scaleImageIcon(new ImageIcon(
				RaceTrack.class
						.getResource("/shared/game/images/car3Green.png")));
		carII[3] = scaleImageIcon(new ImageIcon(
				RaceTrack.class
						.getResource("/shared/game/images/car4Yellow.png")));
		carII[4] = scaleImageIcon(new ImageIcon(
				RaceTrack.class.getResource("/shared/game/images/car5Red.png")));
		return carII;
	}
	...
	private void loadOtherImages() {
		...
		fetch = new ImageIcon(getClass().getResource(
				"/shared/game/images/checkpointFeedback.png"));
		...
		for (int i = 0; i < powerupImages.length; i++) {
			fetch = new ImageIcon(getClass().getResource(
					"/shared/game/images/" + powerupImageNames[i] + ".png"));
	...
	private void loadCarImages() {
		...
		for (int j = 1; j <= diffCars; j++) { // j is the amount of different
			...
			for (int i = 0; i < carColors.length; i++) {
				fetch = new ImageIcon(getClass().getResource(
						"/shared/game/images/car" + j + carColors[i] + ".png"));
				/*
	...
	private void loadTiles() {
		...
		for (int i = 0; i < defineTiles.length; i++) {
			fetch = new ImageIcon(getClass().getResource(
					"/shared/game/images/" + defineTiles[i].getFileName()
							+ ".png"));
